...
export const metadata: Metadata = {
    ...
    description:
        'Explore upcoming and past events by ACES at Bharati Vidyapeeth\'s College of Engineering, Pune. Attend hackathons, AI/ML workshops, IEEE conferences, cultural events, and more. Register now!',
    keywords: [
        'ACES BVCOE events',
    ...
    openGraph: {
        ...
        description:
            'Upcoming and past events by ACES at Bharati Vidyapeeth\'s College of Engineering, Pune — including IEEE ICRAES 2026, workshops, sports, and cultural events.',
